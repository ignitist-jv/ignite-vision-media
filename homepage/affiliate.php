  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-3">
              <a class="inline-block py-2 px-4 text-black font-bold no-underline" href="contact.php">Contact Us</a>
            </li>
            <!-- <li class="mr-3">
      ...
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          ...
          <h1 class="my-4 text-5xl font-bold leading-tight">
            Welcome to the Official Affiliate Hub!
          </h1>
          <p class="leading-normal text-2xl mb-8">
            We’re thrilled to have you on board!
          </p>
          <p class="leading-normal text-xl mb-8 text-justify">
            Whether you’re a seasoned marketer or just getting started, we’ve made it simple for you to begin promoting our high-converting offers. Below, you’ll find each product listed with everything you need—affiliate links, swipe files, creatives, and more.
          </p>
          <p class="leading-normal text-xl mb-8 text-justify">
            Just click on any product below to access its full affiliate resources and start earning commissions today.
          </p>
          <p class="leading-normal text-xl mb-8">
            Thank you for partnering with us. Let’s grow together!
          </p>
    ...
    <section class="bg-white border-b py-8">
      <div class="container mx-auto flex flex-wrap pt-4 pb-12">
        ...
        <div class="w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink transform transition hover:scale-105 duration-300 ease-in-out">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="https://wealthancestryprayer.com/affiliate/" target="_blank" class="flex flex-wrap no-underline hover:no-underline">
              <!-- <p class="w-full text-gray-600 text-xs md:text-sm px-6">
                xGETTING STARTED
              </p> -->
              <div class="w-full text-center font-semibold text-4xl text-gray-800 px-6 mb-4">
                Wealth Ancestry Prayer <span class="text-red-500">(New)</span>
              </div>
              <div class="w-full flex justify-center items-center">
                <img class="w-full md:w-3/5" src="images/wealth-ancestry-prayer.png" />
              </div>
          ...
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
            <div class="flex items-center justify-center">
              <a href="https://wealthancestryprayer.com/affiliate/" target="_blank"
                class="text-2xl text-center w-full mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
        ...
        <div class="w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink transform transition hover:scale-105 duration-300 ease-in-out">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="https://infinitewealthcodereading.com/affiliate/" target="_blank" class="flex flex-wrap no-underline hover:no-underline">
              <!-- <p class="w-full text-gray-600 text-xs md:text-sm px-6">
                xGETTING STARTED
              </p> -->
              <div class="w-full text-center font-semibold text-4xl text-gray-800 px-6 mb-4">
                Infinite Wealth Code Reading <span class="text-red-500">(New)</span>
              </div>
              <div class="w-full flex justify-center items-center">
                <img class="w-full md:w-3/5" src="images/infinite-wealth-code-reading.png" />
              </div>
              <!-- <p class="text-gray-800 text-base px-6 mb-5">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at ipsum eu nunc commodo posuere et sit amet ligula.
              </p> -->
          ...
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
            <div class="flex items-center justify-center">
              <a href="https://infinitewealthcodereading.com/affiliate/" target="_blank"
                class="text-2xl text-center w-full mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                ACCESS AFFILIATE TOOLS
              </a>
            </div>
        ...
        <div class="w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink transform transition hover:scale-105 duration-300 ease-in-out">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="https://instantprosperityprayer.com/affiliate/" target="_blank" class="flex flex-wrap no-underline hover:no-underline">
              <!-- <p class="w-full text-gray-600 text-xs md:text-sm px-6">
                xGETTING STARTED
              </p> -->
              <div class="w-full text-center font-semibold text-4xl text-gray-800 px-6 mb-4">
              ...
              <div class="w-full flex justify-center items-center">
                <img class="w-full md:w-3/5" src="images/prosperity-prayer.png" />
              </div>
              <!-- <p class="text-gray-800 text-base px-6 mb-5">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at ipsum eu nunc commodo posuere et sit amet ligula.
              </p> -->
          ...
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
            <div class="flex items-center justify-center">
              <a href="https://instantprosperityprayer.com/affiliate/" target="_blank"
                class="text-2xl text-center w-full mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                ACCESS AFFILIATE TOOLS
              </a>
            </div>
        ...
        <div class="w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink transform transition hover:scale-105 duration-300 ease-in-out">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="https://7secondswealthprayer.com/affiliate" target="_blank" class="flex flex-wrap no-underline hover:no-underline">
              <!-- <p class="w-full text-gray-600 text-xs md:text-sm px-6">
                xGETTING STARTED
              </p> -->
              <div class="w-full text-center font-semibold text-4xl text-gray-800 px-6 mb-4">
              ...
              <div class="w-full flex justify-center items-center">
                <img class="w-full md:w-3/5" src="images/seconds-wealth-prayer.png" />
              </div>
              <!-- <p class="text-gray-800 text-base px-6 mb-5">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at ipsum eu nunc commodo posuere et sit amet ligula.
              </p> -->
          ...
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
            <div class="flex items-center justify-center">
              <a href="https://7secondswealthprayer.com/affiliate" target="_blank"
                class="text-2xl text-center w-full mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                ACCESS AFFILIATE TOOLS
              </a>
            </div>
        ...
        <div class="w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink transform transition hover:scale-105 duration-300 ease-in-out">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="https://soulmirrorreading.com/affiliate" target="_blank" class="flex flex-wrap no-underline hover:no-underline">
              <div class="w-full text-center font-semibold text-4xl text-gray-800 px-6 mb-4">
                Soul Mirror Reading <span class="text-red-500">(New)</span>
              </div>
              <div class="w-full flex justify-center items-center">
                <img class="w-full md:w-3/5" src="images/soul-mirror-reading.png" />
              </div>
            </a>
          </div>
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
            <div class="flex items-center justify-center">
              <a href="https://soulmirrorreading.com/affiliate" target="_blank"
                class="text-2xl text-center w-full mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                ACCESS AFFILIATE TOOLS
              </a>
            </div>
