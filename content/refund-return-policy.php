...
<main class="wrap">
  <div class="prose">
    <h2>Customer Satisfaction Guarantee</h2><p>We stand behind the quality of our products. If you are not 100% satisfied with your purchase, we are happy to offer a refund within 30 days of your purchase date.</p><h2>To be eligible for a refund</h2><ul><li>The item must be unused, in its original packaging, and in the same condition that you received it.</li><li>All items must be shipped back to us before a refund is processed.</li><li>Shipping costs for returned items are the responsibility of the customer.</li></ul><h2>Return Address</h2><address>205/124 James Street<br>Leichhardt, NSW 2040<br>Australia<br>Once your return is received and inspected, we will notify you via email. If approved, your refund will be processed to your original method of payment within 5-10 business days.</address><h2>Please note</h2><ul><li>We do not refund items that are lost or damaged during return shipping. We recommend using a trackable shipping service or purchasing shipping insurance.</li><li>Refunds are issued for the price paid for the item only; shipping insurance (if purchased) is non-refundable.</li><li>Refunds are not offered for &quot;change of mind&quot; after the item has been shipped.</li></ul><h2>Need Help?</h2><p>If you have any questions about your order or the return process, please contact our support team at refund@ignitevisionmedia.com .</p>
  </div>
</main>
